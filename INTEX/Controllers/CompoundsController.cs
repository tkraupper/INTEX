...
namespace INTEX
{
    public class CompoundsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "LTNumber,CompoundName,Description")] Compound compound)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "LTNumber,CompoundName,Description")] Compound compound)
        {
            if (ModelState.IsValid)
            {
